namespace BetterMaps.Maui
{
    ...
    {
        private const double EarthCircumferenceKm = GeographyUtils.EarthRadiusKm * 2 * Math.PI;
        private const double MinimumRangeDegrees = 0.001 / EarthCircumferenceKm * 360; // 1 meter

        public MapSpan(Position center, double latitudeDegrees, double longitudeDegrees, double bearing)
            : this(center, latitudeDegrees, longitudeDegrees)
        {
            Bearing = bearing;
        }
        ...
        {
            return HashCode.Combine(Center, LongitudeDegrees, LatitudeDegrees);
        }
        ...
        bool Equals(MapSpan other)
        {
            return Center.Equals(other.Center) &&
                   ...
                   LatitudeDegrees.Equals(other.LatitudeDegrees);
        }
